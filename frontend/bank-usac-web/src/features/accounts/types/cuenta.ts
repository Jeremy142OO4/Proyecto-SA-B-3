...
export interface Cuenta{ idCuenta:string;idCliente:string;numeroCuenta:string;tipoCuenta:'MONETARIA'|'AHORRO'|'CORRIENTE';saldoCentavos:number;moneda:string;estado:EstadoCuenta;ultimaActividad?:string }
