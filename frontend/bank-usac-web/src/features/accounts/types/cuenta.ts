...
export interface Cuenta{ idCuenta:string;idCliente:string;numeroCuenta:string;tipoCuenta:'MONETARIA'|'AHORRO'|'CORRIENTE';saldoCentavos:number;saldoMinimoCentavos:number;comisionTransaccionCentavos:number;moneda:string;estado:EstadoCuenta;ultimaActividad?:string }
