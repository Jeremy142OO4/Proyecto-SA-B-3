...
export interface NuevaTransferencia{idCuentaOrigen:string;idCuentaDestino:string;montoCentavos:number;descripcion?:string;resultadoExternoSimulado:ResultadoExternoSimulado}
