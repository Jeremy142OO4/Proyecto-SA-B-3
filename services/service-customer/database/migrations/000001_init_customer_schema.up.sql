...
CREATE TABLE IF NOT EXISTS customers (
    ...
    role VARCHAR(20) NOT NULL CHECK (role IN ('ADMIN', 'TELLER', 'CLIENTE')),
    status VARCHAR(30) NOT NULL DEFAULT 'PENDIENTE_ACTIVACION' CHECK (status IN ('PENDIENTE_ACTIVACION', 'ACTIVO', 'BLOQUEADO')),
